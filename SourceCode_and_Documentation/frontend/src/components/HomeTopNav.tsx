...
const HomeTopNav = ({ signin }: { signin?: boolean }) => {
  ...
  const [randomTag, setRandomTag] = React.useState<HTMLButtonElement | null>(
    null
  );
  ...
  return (
    <AppBar position="fixed" className={styles.appBar}>
      <Toolbar className={styles.toolBar}>
            ...
            <CardContent className={styles.popoverContent}>
              ...
              <div>
                <div className={styles.media}>
                  <img alt={reefPic} src={reefPic} className={styles.pic} />
                  <div
                    style={{
                      margin: "0 1rem",
                      display: "flex",
                ...
                <p>
                  Being underwater is such a surreal experience, one that I
        ...
        <a href="http://localhost:3000" className={styles.whiteText}>
