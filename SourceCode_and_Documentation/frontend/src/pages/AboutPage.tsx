    ...
    <div className={classes.background}>
      ...
      <Container maxWidth="md" className={classes.page}>
        ...
        <p>
          ...
          <span className={classes.emphasise}><i> share</i></span>,
          <span className={classes.emphasise}><i> discover &</i></span>
          <span className={classes.emphasise}><i> connect</i></span>
        </p>
        <br/>
        <h2>What is WorldPlay?</h2>
        {what.map(line => <p>{line}</p>)}
        <br/>
        <h2>How does WorldPlay work?</h2>
        <p>After creating an account and logging in, you will be able to explore special posts called <span className={classes.emphasise}><i>tags </i></span> around the world map.</p>
        {tags.map(line => <p>{line}</p>)}
        <ul>
          <li>Explore tags from around the world, learn about others' personal experiences, culture, travels and broaden your music taste.</li>
          <li>Create your own tags! Import songs that you love or mean a lot to you and share these with others.</li>
        </ul>
      </Container>
    </div>
  );
